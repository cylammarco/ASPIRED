...
lhs6328_twodspec.save_fits(filename='example_output/example_01_a_science_traces',
                           overwrite=True)
...
hilt102_twodspec.ap_extract(
    ...
    jsonstring=False)
'''
hilt102_twodspec.save_fits(filename='example_output/example_01_a_standard_trace',
                           overwrite=True)
...
lhs6328_onedspec.extract_arcspec(display=False, stype='science+standard')

# Find the peaks of the arc
lhs6328_onedspec.find_arc_lines(display=False, stype='science+standard')

# Configure the wavelength calibrator
lhs6328_onedspec.initialise_calibrator(min_wavelength=3500, max_wavelength=8000, stype='science+standard')
...
lhs6328_twodspec.save_fits(filename='example_output/example_01_b_science_trace',
                           overwrite=True)
